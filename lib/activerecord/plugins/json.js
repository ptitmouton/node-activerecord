(function() {
  ...
  module.exports = json = (function(_super) {
    ...
    json.prototype.toJSON = function(incRelations, cb) {
      var assocName, association, field, pretty, queryWait, type, _i, _j, _len, _len1, _ref1, _ref2, _results;
      ...
      if (incRelations) {
        queryWait = {};
        _ref2 = ['hasOne', 'belongsTo', 'hasMany'];
        _results = [];
